import { oas3, oas2, oas3_1, extractDraftVersion, oas3_0 } from '@stoplight/spectral-formats';
import { schema, unreferencedReusableObject, truthy, pattern, length, alphabetical, undefined as undefined$1, xor } from '@stoplight/spectral-functions';
...
const getAllOperations$3 = function *(paths) {
...
var _spectral = {
  ...
  "rules": {
    "R01-api-info-description-non-empty": {
      "given": ["#API_Document"],
      "severity": "error",
      "then": {
        "function": truthy,
      ...
      "description": "## Codigo: R01\n## Regla: descripciÃ³n de la API no puede estar vacio.\nSe debe de proporcionar la descripciÃ³n de la API, mayor detalle ## Causa\nLa API no tiene la propiedad info.description.\n## SoluciÃ³n\nRegistrar la descripciÃ³n de la API.\n## Ejemplo\n\n```yaml lineNumbers\nopenapi: 3.0.1\ninfo:\n  description: descripcion de mi API.\n```",
      "message": "R01: La descripciÃ³n de la API no puede estar vacÃ­o."
    },
    "R02-api-info-title-non-empty": {
      "given": ["#API_Document"],
      "severity": "error",
      "then": {
        "function": truthy,
      ...
      "description": "## Codigo: R02\n## Regla: El titulo de la API no puede estar vacio.\nSe debe de proporcionar el titulo de la API, mayor detalle ## Causa\nLa API no tiene la propiedad info.title.\n## SoluciÃ³n\nRegistrar el titulo de la API.\n## Ejemplo\n\n```yaml lineNumbers\nopenapi: 3.0.1\ninfo:\n  title: Titulo de mi API\n```",
      "message": "R02: El tÃ­tulo de la API no puede estar vacÃ­o."
    },
    "R03-api-endpoint-summary-regex": {
      ...
      "description": "## Codigo: R03\n## Regla: El resumen del endpoint debe de iniciar en mayuscula y terminar en punto.\nSe debe de registrar el resumen del endpoint iniciar en mayuscula y terminar en punto, mayor detalle  Causa\nEl resumen del EndPoint no cumple con la expresiÃ³n regular.\n\n`^[A-Z].*[.]$.`\n\n## SoluciÃ³n\nRegistrar el resumen del endpoint en base a la expresiÃ³n regular evaluada.\n## Ejemplo\n\n```yaml lineNumbers\npaths:\n  /debts/{debtId}:\n    get:\n      sumary: Realiza la consulta de la deuda de un cliente.\n```",
      "message": "R03: El resumen del endpoint debe de iniciar en mayÃºscula y terminar en punto."
    },
    "contact-url": {
      "given": ["#API_Contact"],
      "severity": "off",
...
//export default { extends: _spectral };
